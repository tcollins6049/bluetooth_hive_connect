...
/**
 * Variables for the appmais timing modal
 */
interface TimingProps {
    isVisible: boolean; // Is the modal visible or not
    onClose: () => void;    // What to do when closing the modal
}
...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 18, fontWeight: 'bold', marginBottom: 10, alignItems: 'center' },
    listContainer: { marginBottom: 20 },
    listItemContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', width: '100%', paddingVertical: 5 },
    listItem: { fontSize: 16, textAlign: 'left', marginLeft: 10 },
    closeButton: { marginTop: 10, paddingVertical: 8, paddingHorizontal: 16, backgroundColor: '#007bff', borderRadius: 5 },
