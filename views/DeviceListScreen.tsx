...
import { View, Button, Text, PermissionsAndroid, StyleSheet, TouchableHighlight, Image, Alert, TouchableOpacity } from 'react-native';
...
const DeviceListScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    // Once the app starts, it starts the connection process
    useEffect(() => {
...
import { View, Button, Text, PermissionsAndroid, StyleSheet, TouchableOpacity, Alert, FlatList } from 'react-native';
